...
@Configuration
public class GithubOath {

    @Autowired
    @Qualifier("oauth2ClientContext")
    private OAuth2ClientContext oauth2ClientContext;

    public OAuth2ClientAuthenticationProcessingFilter githubFilter() {
        ...
        final UserInfoTokenServices tokenServices = new UserInfoTokenServices(githubResource().getUserInfoUri(), github().getClientId());
